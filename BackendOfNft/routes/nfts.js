...
const contractAddress = "0x241A0FcFc9e11af0794bb00f99962DB6B5d1d77B";
// 0x241a0fcfc9e11af0794bb00f99962db6b5d1d77b
const contractABI = [
	{
		"constant": false,
		"inputs": [
...
router.post("/mintToken", async (req, res) => {
  ...
  const transferFunction = contract.methods.mint(url,value)
  .encodeABI();
